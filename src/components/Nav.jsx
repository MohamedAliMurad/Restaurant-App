        ...
        <>
            ...
            >
                <div className="container w-100">
                    {/* <!-- LOGO --> */}
                    <Link className="logo d-flex align-items-center justify-content-center" to='' onClick={clickLogo}>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div className={`icons d-flex ${login ? 'w-25' : 'w-100 justify-content-end'}`}>
                            ...
                            <div className="login">
                                {!login ?
                                    <Link className='nav-link' to="login" style={{ color: '#ff4e00', fontWeight: 'bold' }}>Login</Link>
                                    :
                                    <Link className='nav-link' to="login" style={{ color: '#ff4e00', fontWeight: 'bold' }}>Logout</Link>
                                }
                            </div>
                        </div>
                    </div>
